...
- **west-fs:** EXTERNAL_SIP_IP=8.229.177.165, EXTERNAL_RTP_IP=8.229.177.165, DB_HOST=10.142.0.103 (interim), API_HOST=10.142.0.103, HOMER_IP=10.142.0.103, SBC_PROXY_IP=10.138.0.100, SBC_PROXY_IP_FAILOVER=10.138.0.101, **HEP_CAPTURE_ID=210** (East FS=200; without this West FS mislabels as East in Homer), TEST_MODE=false
