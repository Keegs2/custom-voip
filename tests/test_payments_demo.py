...
throwaway PostgreSQL cluster, bootstrap the minimal schema, apply BOTH the Wave-1
ledger migration AND the demo migration, and exercise the ACTUAL demo services +
...
MIG_LEDGER = REPO / "docker" / "postgres" / "migrations" / "2026-07-20_payments_ledger.sql"
MIG_DEMO = REPO / "docker" / "postgres" / "migrations" / "2026-07-20_payments_demo.sql"
...
# Minimal schema (mirrors tests/test_ledger.py) — enough to apply both migrations.
_BASE_SCHEMA = """
