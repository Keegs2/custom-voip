  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        <Link to="/programmable-voice" style={{ textDecoration: 'none' }}>
          <Button variant="ghost">Open Programmable Voice</Button>
        </Link>
  ...
  return (
    <div style={{ paddingTop: 20 }}>
      <PortalHeader
        ...
        subtitle="Programmable voice — drive every call with webhooks and TwiML, with real-time status callbacks."
        badgeVariant="api"
      />
