...
if product_type == "rcf" then
    ...
    --   REPLY_HANDLER strips the 200 OK SDP when a 183 with SDP
    --   was already forwarded, preventing the SOA double-answer
    --   error. Do NOT set sip_enable_soa=false — it disables the
