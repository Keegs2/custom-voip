...
if product_type == "rcf" then
    ...
    --
    --   SOA stays ENABLED (default). FS generates its own SDP for
    --   both legs, so there's no double-answer issue. The A-leg
    --   SDP and B-leg SDP are independent FS-generated offers.
    --
