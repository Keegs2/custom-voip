...
class RegisterRequest(BaseModel):
    ...
    password: str
    name: str
    # NOTE: role defaults to "user" but admins may set "admin" here.
    # This is intentional — only authenticated admins (require_admin
    # dependency on the /register endpoint) can create users, so allowing
    # admin-to-admin creation is by design.
    role: str = "user"
