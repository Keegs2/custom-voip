...
This mirrors the STT/LLM/TTS provider pattern already in the codebase: a thin,
vendor-agnostic interface plus a safe no-op default. The concrete rails plug in
...
Wave 1 ships ONLY :class:`NoopProvider`: every money-moving method refuses. There
is intentionally NO live provider, NO API key, NO network call, and NO money
movement in this wave — this file is purely the seam the rails snap into.
