...
The default (non-demo) resolution is ONLY :class:`NoopProvider` (no live rail;
every money op refuses) — the concrete Stripe/x402/MPP providers register here
in later waves WITHOUT touching callers.
