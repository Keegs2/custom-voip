...
Bulk ingest: `/v1/cdrs/ingest/bulk` accepts a JSON array of CDR objects, max 1000 per batch. Response tallies `ok` / `duplicate` / `error` / `b_leg`.
